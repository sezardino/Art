...
var accordion = function accordion() {
  ...
  showSlide(0);
  heading.forEach(function (item, index) {
...
var calc = function calc() {
  ...
  var selectInput = form.querySelectorAll('select');
  var totalPrice = form.querySelector('.calc-price');
  var promoInput = form.querySelector('.promocode');
  var promo,
      sum = 0;
  ...
  var calcPrice = function calcPrice() {
    ...
    if (selectInput[0].value && selectInput[1].value) {
      sum = Math.round(selectInput[0].value * selectInput[1].value + selectInput[2].value) * (promo ? 0.3 : 1);
      totalPrice.textContent = sum;
    }
  };

  var onPromoInputInput = function onPromoInputInput(evt) {
...
var forms = function forms() {
  ...
  var onUploadChange = function onUploadChange(evt) {
    var sibling = evt.target.previousElementSibling;
    var arr = evt.target.files[0].name.split('.');
    var dots = arr[0].length > 8 ? '...' : '.';
    var name = arr[0].slice(0, 7) + dots + arr[1];
  ...
  form.forEach(function (element) {
    element.addEventListener('submit', function (evt) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_7__["postData"])(api, formData).then(function (response) {
...
/***/ "./src/js/components/hoverEffect.js":
/*!******************************************!*\
  !*** ./src/js/components/hoverEffect.js ***!
  \******************************************/
/*! exports provided: default */
...
var hoverEffect = function hoverEffect() {
  ...
  var onWrapperMouseEnter = function onWrapperMouseEnter(evt) {
    var target = evt.target;
    var img = target.querySelector('img');
    img.src = img.src.slice(0, -4) + '-1.png';
    var p = target.querySelectorAll('p:not(.sizes-hit)');
  ...
  var onWrapperMouseLeave = function onWrapperMouseLeave(evt) {
    var target = evt.target;
    var img = target.querySelector('img');
  ...
  bloks.forEach(function (block) {
    block.addEventListener('mouseenter', function (evt) {
      return onWrapperMouseEnter(evt);
    });
    block.addEventListener('mouseleave', function (evt) {
      return onWrapperMouseLeave(evt);
    });
  });
};

/* harmony default export */ __webpack_exports__["default"] = (hoverEffect);
...
/*!*************************************!*\
  !*** ./src/js/components/inputs.js ***!
  \*************************************/
/*! exports provided: phoneInputValidate, textInputsCheck */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "phoneInputValidate", function() { return phoneInputValidate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "textInputsCheck", function() { return textInputsCheck; });
...
var phoneInputValidate = function phoneInputValidate(selector) {
  var phoneInputs = document.querySelectorAll(selector);

  var checkPhone = function checkPhone() {
    var value = this.value;
    var validityMessage = 'Введите номер в формате +11 111 111 111'; // if (value.matches(/\D/gi))
    ...
    var str = value.replace(/[a-z, а-яё]/gi, '');
    this.value = str;
  };
...
var textInputsCheck = function textInputsCheck(selector) {
  var textInputs = document.querySelectorAll(selector);

  var checkText = function checkText() {
    var value = this.value;
    var str = value.replace(/[^а-яё 0-9]/gi, '');
    this.value = str;
  };
...
var modals = function modals(trigerSelector, modalSelector, closeBtnSelector) {
  ...
  var trigers = document.querySelectorAll(trigerSelector),
  ...
  var onTrigerClick = function onTrigerClick(evt) {
    evt.preventDefault();
    activity = true;
  ...
  var openModalTimer = function openModalTimer(time) {
    if (timeOut) {
      setTimeout(function () {
        var modalShow;
  ...
  var openGiftPopup = function openGiftPopup() {
  ...
  var onWindowScroll = function onWindowScroll() {
    ...
    var nowHeight = window.pageYOffset + document.documentElement.clientHeight;
  ...
  trigers.forEach(function (triger) {
    return triger.addEventListener('click', onTrigerClick);
  });
...
var portfolio = function portfolio(filtersParent, filter, worksSelector, fish) {
  var filtersContainer = document.querySelector(filtersParent),
  ...
  var showWorks = function showWorks(filter) {
    if (!filterName) {
  ...
  var onFiltersContainerClick = function onFiltersContainerClick(evt) {
    var target = evt.target;
...
/***/ "./src/js/components/showMoreCards.js":
/*!********************************************!*\
  !*** ./src/js/components/showMoreCards.js ***!
  \********************************************/
/*! exports provided: default */
...
var showMoreCards = function showMoreCards(button, cardsSelector, container) {
  ...
  var renderCards = function renderCards(arr) {
    var items = arr.map(function (_ref) {
      var src = _ref.src,
          title = _ref.title,
          link = _ref.link;
  ...
  var onTriggerClick = function onTriggerClick() {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getData"])(url).then(function (res) {
      return renderCards(res);
    });
    this.classList.add('hidden');
  };

  trigger.addEventListener('click', onTriggerClick); // cards.forEach((card) => card.classList.add('animated', 'fadeInUp'));
...
var slider = function slider(slidesSelector, direction, prev, next) {
...
/* harmony import */ var _components_inputs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/inputs */ "./src/js/components/inputs.js");
/* harmony import */ var _components_showMoreCards__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/showMoreCards */ "./src/js/components/showMoreCards.js");
/* harmony import */ var _components_calc__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/calc */ "./src/js/components/calc.js");
...
/* harmony import */ var _components_hoverEffect__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/hoverEffect */ "./src/js/components/hoverEffect.js");
...
/* harmony import */ var _components_burger__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/burger */ "./src/js/components/burger.js");
...
document.addEventListener('DOMContentLoaded', function () {
  Object(_components_modals__WEBPACK_IMPORTED_MODULE_0__["default"])('.button-design', '.popup-design', '.popup-close');
  Object(_components_modals__WEBPACK_IMPORTED_MODULE_0__["default"])('.button-consultation', '.popup-consultation', '.popup-close', true);
  Object(_components_modals__WEBPACK_IMPORTED_MODULE_0__["default"])('.fixed-gift', '.popup-gift', '.popup-close');
  Object(_components_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.main-slider-item', 'vertical');
  Object(_components_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', '', '.main-prev-btn', '.main-next-btn');
  Object(_components_forms__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_components_inputs__WEBPACK_IMPORTED_MODULE_3__["phoneInputValidate"])('[name=phone]');
  Object(_components_inputs__WEBPACK_IMPORTED_MODULE_3__["textInputsCheck"])('[name=name]');
  Object(_components_inputs__WEBPACK_IMPORTED_MODULE_3__["textInputsCheck"])('[name=message]');
  Object(_components_showMoreCards__WEBPACK_IMPORTED_MODULE_4__["default"])('.button-styles', '.styles-2', '.styles-container');
  Object(_components_calc__WEBPACK_IMPORTED_MODULE_5__["default"])();
  Object(_components_portfolio__WEBPACK_IMPORTED_MODULE_6__["default"])('.portfolio-menu', '[data-portfolio]', '.portfolio-block', '.portfolio-no');
  Object(_components_hoverEffect__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_components_accordion__WEBPACK_IMPORTED_MODULE_8__["default"])();
  Object(_components_burger__WEBPACK_IMPORTED_MODULE_9__["default"])('.burger', '.burger-menu');
});
